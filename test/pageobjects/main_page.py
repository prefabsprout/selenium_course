...
class MainPage(BasePage):
    ...
    @allure.step("Check if user {authorised_user_full_name} authorized")
    ...
    @allure.step("Assert that there are {button_name} button on the header section have proper text")
    ...
    @allure.step("Assert that there are {icon_name} icon on the Index Page and it's displayed")
    ...
    @allure.step("Assert that there is {text} on the Index Page under icon {icon_name} and it have proper text")
    ...
    @allure.step("Assert that there is {button_name} button in the Left Section have proper text")
